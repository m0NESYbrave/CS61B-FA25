...
public class LinkedListDeque61BTest {
    ...
    public void getTest() {
        ...
        assertThat(lld1.get(0)).isNull(); // out-of-bound large

        lld1.addFirst(0);
        lld1.addLast(1);
        lld1.addLast(2);

        assertThat(lld1.get(-1)).isNull(); // out-of-bound negative
    ...
    public void getRecursiveTest() {
        ...
        assertThat(lld1.getRecursive(0)).isNull(); // out-of-bound large

        lld1.addFirst(0);
        lld1.addLast(1);
        lld1.addLast(2);

        assertThat(lld1.getRecursive(-1)).isNull(); // out-of-bound negative
    ...
    public void removeFirstAndLastTest() {
        ...
        assertThat(lld1.toList()).containsExactly(4, 2, 1, 0).inOrder();
